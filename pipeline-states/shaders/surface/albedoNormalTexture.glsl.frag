...
void main ()
{
	...
	forwardLightingModel(g43, N, V, FragmentInput_sve_position, (albedo * MaterialState.albedo), MaterialState.smoothness, MaterialState.fresnel);
	FragmentOutput_sve_color = g43;
}
