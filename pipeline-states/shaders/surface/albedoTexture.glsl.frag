...
void main ()
{
	...
	forwardLightingModel(g16, N, V, FragmentInput_sve_position, (albedo * MaterialState.albedo), MaterialState.smoothness, MaterialState.fresnel);
	FragmentOutput_sve_color = g16;
}
