...
void main ()
{
	...
	reflectionFresnel = _g2;
	_g3 = fresnelSchlick(lightedColor.w, NdotV);
	reflectionFactor = _g3;
	FragmentOutput_sve_color = vec4(((skyColor.xyz * reflectionFresnel) + lightedColor.xyz), reflectionFactor);
}
