...
metal::float3 transformNormalToView (metal::float3 arg1, device const InstanceObjectState_bufferBlock* InstanceObjectState, device const ObjectState_block* ObjectState, device const CameraState_block* CameraState, unsigned int VertexStage_sve_instanceID);
metal::float4 transformVector4ToView (metal::float4 arg1, device const InstanceObjectState_bufferBlock* InstanceObjectState, device const CameraState_block* CameraState, device const ObjectState_block* ObjectState, unsigned int VertexStage_sve_instanceID);
metal::float4 transformPositionToView (metal::float3 arg1, unsigned int VertexStage_sve_instanceID, device const ObjectState_block* ObjectState, device const CameraState_block* CameraState, device const InstanceObjectState_bufferBlock* InstanceObjectState);
metal::float4 transformPositionToWorld (metal::float3 arg1, unsigned int VertexStage_sve_instanceID, device const ObjectState_block* ObjectState, device const InstanceObjectState_bufferBlock* InstanceObjectState);
...
metal::float3 skinPosition (metal::float3 arg1, device const PoseState_bufferBlock* PoseState, thread metal::float4* SkinnedGenericVertexLayout_sve_boneWeights, thread metal::int4* SkinnedGenericVertexLayout_sve_boneIndices);
metal::float3 skinVector (metal::float3 arg1, device const PoseState_bufferBlock* PoseState, thread metal::int4* SkinnedGenericVertexLayout_sve_boneIndices, thread metal::float4* SkinnedGenericVertexLayout_sve_boneWeights);
vertex _SLVM_ShaderStageOutput shaderMain (_SLVM_ShaderStageInput _slvm_stagein [[stage_in]], device const PoseState_bufferBlock* PoseState [[buffer(3)]], device const ObjectState_block* ObjectState [[buffer(1)]], unsigned int VertexStage_sve_instanceID [[instance_id]], device const CameraState_block* CameraState [[buffer(4)]], device const InstanceObjectState_bufferBlock* InstanceObjectState [[buffer(2)]]);
metal::float3 cameraWorldPosition (device const CameraState_block* CameraState)
{
...
{
	metal::float4 _g2;
	_g2 = transformVector4ToView(metal::float4(arg1, 1.0), InstanceObjectState, CameraState, ObjectState, VertexStage_sve_instanceID);
	return _g2;
}
...
vertex _SLVM_ShaderStageOutput shaderMain (_SLVM_ShaderStageInput _slvm_stagein [[stage_in]], device const PoseState_bufferBlock* PoseState [[buffer(3)]], device const ObjectState_block* ObjectState [[buffer(1)]], unsigned int VertexStage_sve_instanceID [[instance_id]], device const CameraState_block* CameraState [[buffer(4)]], device const InstanceObjectState_bufferBlock* InstanceObjectState [[buffer(2)]])
{
	...
	_g20 = skinVector((*SkinnedGenericVertexLayout_sve_tangent4).xyz, PoseState, SkinnedGenericVertexLayout_sve_boneIndices, SkinnedGenericVertexLayout_sve_boneWeights);
	_g21 = transformNormalToView(_g20, InstanceObjectState, ObjectState, CameraState, VertexStage_sve_instanceID);
	(*VertexOutput_sve_tangent) = _g21;
	_g22 = skinVector((*SkinnedGenericVertexLayout_sve_normal), PoseState, SkinnedGenericVertexLayout_sve_boneIndices, SkinnedGenericVertexLayout_sve_boneWeights);
	_g23 = transformNormalToView(_g22, InstanceObjectState, ObjectState, CameraState, VertexStage_sve_instanceID);
	...
	_g25 = skinPosition((*SkinnedGenericVertexLayout_sve_position), PoseState, SkinnedGenericVertexLayout_sve_boneWeights, SkinnedGenericVertexLayout_sve_boneIndices);
	_g26 = transformPositionToView(_g25, VertexStage_sve_instanceID, ObjectState, CameraState, InstanceObjectState);
	_l_position4 = _g26;
