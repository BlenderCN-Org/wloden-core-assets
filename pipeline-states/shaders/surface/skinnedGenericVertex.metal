...
metal::float3 transformNormalToView (metal::float3 arg1, unsigned int VertexStage_sve_instanceID, device const CameraState_block* CameraState, device const ObjectState_block* ObjectState, device const InstanceObjectState_bufferBlock* InstanceObjectState);
...
vertex _SLVM_ShaderStageOutput shaderMain (_SLVM_ShaderStageInput _slvm_stagein [[stage_in]], device const ObjectState_block* ObjectState [[buffer(1)]], unsigned int VertexStage_sve_instanceID [[instance_id]], device const PoseState_bufferBlock* PoseState [[buffer(3)]], device const InstanceObjectState_bufferBlock* InstanceObjectState [[buffer(2)]], device const CameraState_block* CameraState [[buffer(4)]])
{
	...
	_g21 = transformNormalToView(_g20, VertexStage_sve_instanceID, CameraState, ObjectState, InstanceObjectState);
	...
	_g23 = transformNormalToView(_g22, VertexStage_sve_instanceID, CameraState, ObjectState, InstanceObjectState);
	...
	_g26 = transformPositionToView(_g25, VertexStage_sve_instanceID, ObjectState, InstanceObjectState, CameraState);
	_l_position4 = _g26;
