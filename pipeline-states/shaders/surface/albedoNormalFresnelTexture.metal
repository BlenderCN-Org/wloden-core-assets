...
fragment _SLVM_ShaderStageOutput shaderMain (_SLVM_ShaderStageInput _slvm_stagein [[stage_in]], metal::texture2d<float> fresnelTexture [[texture(4)]], metal::sampler normalSampler [[sampler(1)]], device const MaterialState_block* MaterialState [[buffer(5)]], metal::texture2d<float> normalTexture [[texture(3)]], device const GlobalLightingState_block* GlobalLightingState [[buffer(4)]], metal::sampler albedoSampler [[sampler(0)]], metal::texture2d<float> albedoTexture [[texture(0)]]);
metal::float3 cameraWorldPosition (device const CameraState_block* CameraState)
{
